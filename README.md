...
```sh
npm install git+ssh://git@github.com:JettiHQ/charcoal-node.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/JettiHQ/charcoal-node/issues) with questions, bugs, or suggestions.
